...
PANEL.Base = "DFrame"
PANEL.menu_bar = NULL
PANEL.pac3_PanelsToRemove = {"btnMaxim", "btnMinim"}
local BAR_SIZE = 17
...
function PANEL:Init()
	...
	self.exit_button.DoClick = function()
		self:Close()
	end
	self.exit_button.Paint = function(self, w, h)
		derma.SkinHook("Paint", "WindowCloseButton", self, w, h)
	end
