...
function pace.util.FriendlyName(strIn)
	...
	for i, charIn in ipairs(iterableArray) do
		...
		elseif isUpperCase(charIn) then
			...
			local condUpper = charIn == "m" and
				iterableArray[i + 1] == "p" and
				iterableArray[i - 1] == " " or
				charIn == "p" and
				iterableArray[i - 1] == "m" and
				iterableArray[i - 2] == " " or
				charIn == "w" and
				(iterableArray[i - 1] == "C" or iterableArray[i - 1] == "c") or
				charIn == "c" and
				iterableArray[i + 1] == "w" or
				charIn == "i" and
				(iterableArray[i - 1] == "C" or iterableArray[i - 1] == "c") or
				charIn == "c" and
				iterableArray[i + 1] == "i" or
				(charIn == "x" or charIn == "y" or charIn == "z") and
				not iterableArray[i + 1] and
				iterableArray[i - 1] == " "
