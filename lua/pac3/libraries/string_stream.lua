...
local function StringStream(stream, i, endian)
	local ret = setmetatable({index = 1, subindex = 1}, ss_meta)
...
do
	...
	local write_functions = {
			[TYPE_NIL] = function(s, t, v)
				s:writeInt8(t)
			end,
			[TYPE_STRING] = function(s, t, v)
				s:writeInt8(t)
				s:writeString(v)
			end,
			[TYPE_NUMBER] = function(s, t, v)
				s:writeInt8(t)
				s:writeDouble(v)
			end,
			[TYPE_TABLE] = function(s, t, v)
				s:writeInt8(t)
				s:writeTable(v)
			end,
			[TYPE_BOOL] = function(s, t, v)
				s:writeInt8(t)
				s:writeBool(v)
			end,
			[TYPE_VECTOR] = function(s, t, v)
				s:writeInt8(t)
				s:writeVector(v)
			end,
			[TYPE_ANGLE] = function(s, t, v)
				s:writeInt8(t)
				s:writeAngle(v)
			end,
			[TYPE_COLOR] = function(s, t, v)
				s:writeInt8(t)
				s:writeColor(v)
			end,
			[TYPE_ENTITY] = function(s, t, v)
				s:writeInt8(t)
				s:writeEntity(v)
			end,
		}
	...
	local read_functions = {
			...
			[TYPE_NUMBER] = function(s)
				return s:readDouble()
			end,
			[TYPE_TABLE] = function(s)
				return s:readTable()
			end,
			[TYPE_BOOL] = function(s)
				return s:readBool()
			end,
			[TYPE_VECTOR] = function(s)
				return s:readVector()
			end,
			[TYPE_ANGLE] = function(s)
				return s:readAngle()
			end,
			[TYPE_COLOR] = function(s)
				return s:readColor()
			end,
			[TYPE_ENTITY] = function(s)
				return s:readEntity()
			end,
		}
