...
webaudio.FilterType = {None = 0, LowPass = 1, HighPass = 2,}
...
DECLARE_PROPERTY("FilterType", ".filter_type = %i")
		...
		DECLARE_PROPERTY("FilterFraction", ".filter_fraction = %f", 0, function(num)
			return math.Clamp(num, 0, 1)
		end)

		DECLARE_PROPERTY("Echo", ".useEcho(%s)", false)

		DECLARE_PROPERTY("EchoDelay", ".setEchoDelay(Math.ceil(audio.sampleRate * %f))", 1, function(num)
