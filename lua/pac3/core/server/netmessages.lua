...
util.AddNetworkString("pac.net.hasVfs")
util.AddNetworkString("pac.net.hasVfs.ClientNotify")
net.Receive( "pac.net.hasVfs.ClientNotify", function( length, client )
	b = (net.ReadBit() == 1)
	net.Start("pac.net.hasVfs")
	net.WriteEntity(client)
	net.WriteBit(b)
	net.Broadcast()
end )
